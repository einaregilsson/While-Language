...
namespace Demo
{
    ...
    [ProvideLanguageExtension(typeof(IronyLanguageService), ".w")]
    ...
    [ProvideLoadKey("Standard", "1.0", "While", "Einar Egilsson", 104)]
    [Guid(GuidList.guidIronyLanguageServicePkgString)]
    public sealed class WhileLanguageService : IronyPackage
    {
        /// <summary>
